## Cascade Operator == Cascade Notion (23'07'03)
...
이런 예제가 있을때, compiler는 compile-time에 const를 알고있기 때문에 상위 2줄에서 변수를 메모리에 할당하지 않는다.

대신에, 마지막줄을 final c = 10 + 20; 이런식으로 사용하여 final보다 메모리를 아낄 수 있도록 해 주는 것이다.

### 즉 compile 할때 이미 compiler가 값을 알고있어야 한다는 조건이 붙는다
